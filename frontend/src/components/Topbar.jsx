        ...
        <div className="flex items-center gap-2">
          {user && (
            <div className="hidden items-center gap-1.5 sm:flex">
              <span className="flex items-center gap-1 rounded-full bg-accent-400/15 px-2.5 py-1 text-xs font-semibold text-accent-600 tabular-nums">
                <Star className="h-3.5 w-3.5 fill-accent-400 text-accent-500" />
                {user.xp ?? 0} XP
              </span>
              <span className="flex items-center gap-1 rounded-full bg-amber-50 px-2.5 py-1 text-xs font-semibold text-amber-700 tabular-nums">
