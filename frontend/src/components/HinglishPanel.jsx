  ...
  return (
    <section className="mt-12 border-t border-slate-200 pt-8 dark:border-white/10">
      <button
        ...
        className="flex items-center gap-2 rounded-xl border border-accent-500/40 bg-accent-400/10 px-4 py-2.5 text-sm font-semibold text-accent-600 transition hover:bg-accent-400/20 disabled:opacity-60 dark:text-accent-400"
      >
        🗣️ {status === 'loading' ? 'Translating…' : 'Explain in Hinglish'}
      </button>
      ...
      <AnimatePresence>
        {hinglish && (
          <motion.div
            ...
            className="mt-4 rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/[0.03]"
          >
